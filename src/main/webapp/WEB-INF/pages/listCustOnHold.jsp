...
<c:set var="type_large" value="listCustOnHold"/>
<%@ include file="./_largeNavbar.jsp" %>

<div class="modal fade" id="mainModalhold" tabindex="-1" role="dialog" aria-labelledby="mainModalLabel">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="GET" id="formx" action="javascript:void(null);" onsubmit="call()">
                    ...
                    <input id="datatype" name="type" value="1" type="hidden">
                    <input id="hold" name="onhold" value="1"  type="hidden">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header">
                        <h1>Список відкладених записів</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach var="cust" items="${listCustomer}" varStatus="status">
                            <tr  id="${cust.accountnumber}">
                                ...
                                <td>${cust.comm}</td>
                                <td><button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#mainModalhold" data-whatever="${cust.accountnumber}" data-tp="${cust.type}">Обробити</button>

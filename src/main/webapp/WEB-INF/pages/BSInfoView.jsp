...
<!-- main / large navbar -->
<c:set var="type_large" value="BSInfo"/>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-12">
                    <iframe class="my-frame" src="http://81.21.15.145/Stat/Zabbix_Events/Zabbix_Host_Status.html#" marginheight="0" marginwidth="0" frameborder="0" hspace="0" vspace="0" class="content"></iframe >
